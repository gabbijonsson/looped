    ...
    <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-sm border-b border-amber-100 py-3 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between">
          <h1 className="text-xl sm:text-2xl font-bold text-amber-900">CabinVibe Coordinator</h1>
          ...
          <nav className="flex space-x-1 sm:space-x-2">
            ...
            >
              ...
              {!isMobile && <span className="mt-1">Home</span>}
            </Button>
            ...
            >
              ...
              {!isMobile && <span className="mt-1">Food</span>}
            </Button>
            ...
            >
              ...
              {!isMobile && <span className="mt-1">Schedule</span>}
            </Button>
          </nav>
        </div>
      </div>
